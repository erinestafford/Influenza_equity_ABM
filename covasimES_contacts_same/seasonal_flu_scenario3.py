...
if __name__ == '__main__':
	s1=cv.load('cs_but_home_1mil.sim')
	...
	np.savetxt("results/Scenario3_i_num"+str(int(ind))+".txt",infs)
	np.savetxt("results/Scenario3_si_num" + str(int(ind)) + ".txt", symp_infs )
	np.savetxt("results/Scenario3_hrr"+str(int(ind))+".txt",hrr)
	np.savetxt("results/Scenario3_h_num"+str(int(ind))+".txt",hosps)
	np.savetxt("results/Scenario3_icu_num" + str(int(ind)) + ".txt", icus)
	np.savetxt("results/Scenario3_d_num"+str(int(ind))+".txt",deaths)
	np.savetxt("results/Scenario3_reff"+str(int(ind))+".txt",s1.results['r_eff'])